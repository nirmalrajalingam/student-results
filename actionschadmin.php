...
if($_POST)
{
	...
	if($std=='hsc')
	{
		echo "<br><br><center><h1> Higher Secondary Certification Results</h1>";
			...
			if(mysqli_num_rows($result) > 0)
			{
				echo "<table border='1'>";
					echo "<tr>";
						...
						echo "<th>Groupsub</th>";
						echo "<th>Physics Lab</th>";
						echo "<th>Chemistry Lab</th>";
						echo "<th>Groupsub lab</th>";
						echo "<th>Total</th>";
						echo "<th>Average</th>";
						echo "<th>Result</th>";
					echo "</tr>";
	...
	else "Enter the correct standard sslc or hsc";
	mysqli_close($link);
  }
?>
